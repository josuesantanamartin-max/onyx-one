<div align="center">
  <img width="1200" alt="Onyx Suite 2026 Banner" src="https://github.com/user-attachments/assets/0aa67016-6eaf-458a-adb2-6e31a0763ed6" />

  # Onyx Suite 2026
  *>_ The Ultimate Personal Operating System for the Modern Era.*

  [![Vercel Deployment](https://img.shields.io/badge/Deploy-Vercel-black?style=for-the-badge&logo=vercel)](https://onyx-suite-2026.vercel.app)
...
1. **Clone the repository**
   ```bash
   git clone https://github.com/josuesantanamartin-max/onyx-suite-2026.git
   cd onyx-suite-2026
   ```
