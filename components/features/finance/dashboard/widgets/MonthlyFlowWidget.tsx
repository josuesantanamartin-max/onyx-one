...
const MonthlyFlowWidget: React.FC<MonthlyFlowWidgetProps> = ({ monthlyIncome, monthlyExpenses }) => {
    ...
    return (
        <div className="col-span-1 md:col-span-6 lg:col-span-4 bg-white dark:bg-onyx-900 p-8 rounded-onyx border border-onyx-100 dark:border-onyx-800 shadow-sm flex flex-col justify-between hover:shadow-lg transition-all duration-500 group relative overflow-hidden">
