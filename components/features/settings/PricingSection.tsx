    ...
    const plans = [
        {
            ...
            price: '0€',
            description: '14 días con acceso completo para que pruebes Aliseus.',
            features: [
            ...
            <div className="mt-12 p-8 rounded-3xl bg-blue-50 border border-blue-100 flex flex-col md:flex-row items-center justify-between gap-6">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p className="text-sm text-blue-700">Explora Aliseus con un experto y descubre cómo organizar tu vida.</p>
                    </div>
                </div>
