            ...
            <div className="max-w-4xl mx-auto">
                ...
                <div className="mb-12">
                    ...
                    <p className="text-lg text-gray-500 dark:text-gray-400">
                        {language === 'ES'
                            ? 'En Onyx Suite, la privacidad no es una opción, es la base de nuestra arquitectura.'
                            : 'At Onyx Suite, privacy is not an option, it is the foundation of our architecture.'}
                    </p>
                ...
                <div className="space-y-12 text-gray-600 dark:text-gray-300 leading-relaxed">
                    ...
                    <section>
                        ...
                        <p className="mb-4">
                            {language === 'ES'
                                ? 'Onyx Suite opera bajo una filosofía "Local First" (Primero Local). Esto significa que la gran mayoría de sus datos financieros y personales se almacenan exclusivamente en el almacenamiento local de su dispositivo (LocalStorage/IndexedDB) y no se transmiten a nuestros servidores a menos que active explícitamente las funciones de sincronización en la nube.'
                                : 'Onyx Suite operates under a "Local First" philosophy. This means that the vast majority of your financial and personal data is stored exclusively in your device\'s local storage (LocalStorage/IndexedDB) and is not transmitted to our servers unless you explicitly enable cloud synchronization features.'}
                        </p>
                    </section>
                    ...
                    <section>
                        ...
                        <p className="mb-4">
                            {language === 'ES'
                                ? 'Si opta por crear una cuenta y sincronizar sus datos, utilizamos Supabase (un proveedor de Backend-as-a-Service seguro y compatible con GDPR) para almacenar sus datos cifrados. Onyx Suite no vende, alquila ni comparte sus datos personales con terceros para fines publicitarios.'
                                : 'If you choose to create an account and sync your data, we use Supabase (a secure, GDPR-compliant Backend-as-a-Service provider) to store your encrypted data. Onyx Suite does not sell, rent, or share your personal data with third parties for advertising purposes.'}
                        </p>
                    </section>
