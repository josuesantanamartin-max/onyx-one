            ...
            <div className="max-w-4xl mx-auto">
                ...
                <div className="mb-12">
                    ...
                    <p className="text-lg text-gray-500 dark:text-gray-400">
                        {language === 'ES'
                            ? 'Acuerdo de licencia y uso de Onyx Suite.'
                            : 'Licensing and usage agreement for Onyx Suite.'}
                    </p>
                ...
                <div className="space-y-12 text-gray-600 dark:text-gray-300 leading-relaxed">
                    ...
                    <section>
                        ...
                        <p className="mb-4">
                            {language === 'ES'
                                ? 'Al acceder y utilizar Onyx Suite ("la Aplicación"), usted acepta estar legalmente vinculado por estos Términos. Si no está de acuerdo con alguna parte de los términos, no podrá acceder a la Aplicación.'
                                : 'By accessing and using Onyx Suite ("the Application"), you agree to be legally bound by these Terms. If you do not agree with any part of the terms, you may not access the Application.'}
                        </p>
                    </section>
                    ...
                    <section>
                        ...
                        <p className="mb-4">
                            {language === 'ES'
                                ? 'La Aplicación y su contenido original, características y funcionalidad son y seguirán siendo propiedad exclusiva de Onyx Suite y sus licenciantes. La Aplicación está protegida por derechos de autor, marcas registradas y otras leyes tanto de España como de países extranjeros.'
                                : 'The Application and its original content, features, and functionality are and will remain the exclusive property of Onyx Suite and its licensors. The Application is protected by copyright, trademark, and other laws of both Spain and foreign countries.'}
                        </p>
                    </section>
